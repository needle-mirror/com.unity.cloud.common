...
namespace Unity.Cloud.Common
{
    ...
    public readonly struct OrganizationId
    {
        ...
        /// <summary>
        /// Returns a <see cref="OrganizationId"/> using a <see cref="string"/>.
        /// </summary>
        /// <param name="value">The string representing the organization identifier</param>
        public OrganizationId(string value) => m_String = value;

        /// <summary>
        /// Returns whether two <see cref="OrganizationId"/> objects are equals.
        /// </summary>
        ...
        /// </returns>
        public bool Equals(OrganizationId other) => m_String == other.m_String;

        /// <summary>
        /// Validate <paramref name="obj"/> is a <see cref="OrganizationId"/> instance and have the same values as this instance.
        /// </summary>
        ...
        /// <summary>
        /// Get the string representation of this <see cref="OrganizationId"/>.
        /// </summary>
        /// <returns>The string result.</returns>
        public override string ToString() => m_String;

        /// <summary>
        /// Get if two <see cref="OrganizationId"/> represent the same.
        /// </summary>
        ...
        /// <summary>
        /// Get if two <see cref="OrganizationId"/> does not represent the same.
        /// </summary>
        /// <param name="left">Compare with this first instance.</param>
        /// <param name="right">Compare with this other instance.</param>
        /// <returns>
